...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="pt-10 lg:px-20 px-5">
            <Table :plans="vehicles" :shortIcon=true :columns="columns" :show-create-button="true" :show-export-button="true" create-route="/add/sellers" create-title="Add Make" :filter-btn="['Verified', 'Draft', 'Pending', 'Archived','Disabled']">
                <template #image="{ item }">
