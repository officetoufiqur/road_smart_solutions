...
<template>
    ...
    <div style="background-image: url('/assets/img/login.png'); background-size: cover" class="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8">
