...
<template>
    <header
        class="flex justify-between h-16 shrink-0 cursor-pointer items-center gap-2 border-b border-sidebar-border/70 px-6 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4">
